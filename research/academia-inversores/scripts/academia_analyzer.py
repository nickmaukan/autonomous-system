...
def analyze_technical(ticker_symbol):
    ...
    try:
        ...
        # 52 semanas - usar min_periods=1 para datos incompletos
...
def analyze_fundamental(ticker_symbol):
    ...
    try:
        ...
        # Dividend Yield (ya viene en porcentaje de yfinance)
        dividend_yield = info.get('dividendYield')
        if dividend_yield and dividend_yield > 0:
            result["dividends"]["yield"] = {"value": round(dividend_yield, 2)}  # Ya está en %
